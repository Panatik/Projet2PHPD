 ...
 */
class getSportMatchRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SportMatchRepository' shared autowired service.
     *
     * @return \App\Repository\SportMatchRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SportMatchRepository.php';

        return $container->privates['App\\Repository\\SportMatchRepository'] = new \App\Repository\SportMatchRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
